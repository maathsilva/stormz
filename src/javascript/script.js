document.querySelector('#search').addEventListener('submit', async (event) => {
    ...
    const apiKey = '9f3abc4bb77d4051906b80d6aa2364d5';
    ...
    if (json.cod === 200) {
        ...
        showAlert(`
            ...
            <img src="src/images/undraw_Warning_re_eoyh.png"/>
            `)
    }
});
...
function showInfo(json){
    ...
    document.querySelector('#temp_humidity').innerHTML = `${json.humidity}`;
    document.querySelector('#temp_wind').innerHTML = `${json.windSpeed.toFixed(1)}km/h`;
}
